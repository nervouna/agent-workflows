...
description: Use when editing ~/.codex/AGENTS.md from the agent-workflows repository, deciding whether user-level Codex guidance belongs in AGENTS.md or a reusable skill, compressing global instructions, or deploying repository-managed personal skills into ~/.agents/skills.
metadata:
  internal: true
---
